...
def load_dataset(dataset_dir):
    ...
    for img_path in images:
        ...
        fd, new_array = feature.hog(im, orientations=8, pixels_per_cell=(16, 16), cells_per_block=(1, 1), visualise=True)
        ...
        #
        # ax2.axis('off')
        # ax2.imshow(new_array, cmap=plt.cm.gray)
